...
```
cd existing_repo
git remote add origin https://earth.bsc.es/gitlab/oduran/oduran-nemo-omp-tests.git
git branch -M main
...
- [ ] [Set up project integrations](https://earth.bsc.es/gitlab/oduran/oduran-nemo-omp-tests/-/settings/integrations)
