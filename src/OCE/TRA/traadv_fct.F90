...
CONTAINS
   ...
   SUBROUTINE tra_adv_fct( kt, kit000, cdtype, p2dt, pU, pV, pW,       &
      ...
      !
	   ...
	   !$OMP PARALLEL
      !$OMP DO FIRSTPRIVATE(zfp_ui, zfm_ui, zfp_vj, zfm_vj,zfp_wk, zfm_wk,ztra,zC2t_u, zC2t_v, zC4t_u, zC4t_v, zwi, zwx, zwy, zwz, ztu, ztv, zltu, zltv, ztw,ji, jj, jk, iii, jjj, zzz,myshape,zwinf, zwdia, zwsup,ztrdx, ztrdy, ztrdz, zptry)
